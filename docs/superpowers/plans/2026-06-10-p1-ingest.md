...
export function NewConnectionForm() {
    ...
    return (
        <form
            action={formAction}
            className="flex flex-col gap-3 border border-terminal-grid p-4 text-xs"
        >
            ...
            <button
                type="submit"
                className="self-start border border-terminal-amber px-3 py-1 text-terminal-amber hover:bg-terminal-amber hover:text-black"
            >
                CREATE
            </button>
            {state.error && (
            ...
            <table className="w-full text-left text-xs">
                ...
                <tbody>
                    ...
                    {connections.map((c) => (
                        <tr
                            key={c.id}
                            className="border-b border-terminal-grid"
                        >
    ...
    return (
        <div className="flex flex-col text-xs">
            <div className="flex items-center justify-between border-b border-terminal-grid pb-1">
                ...
                <span
                    className={
                        degraded ? "text-terminal-red" : "text-terminal-dim"
                    }
                >
                    ...
                    <tbody>
                        {events.map((e) => {
                            ...
                            return (
                                <tr
                                    key={e.id}
                                    className="border-b border-terminal-grid/50 leading-6"
                                >
...
const { seal, unseal } =
    (await import("../../packages/crypto/src/index.ts").catch(() => null)) ??
...
if (connection) {
    secret = unseal(
        Buffer.from(connection.webhookSecretEnc),
